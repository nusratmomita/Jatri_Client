...
const Footer = () => {
    return (
       <footer className="flex lg:flex-row flex-col justify-between footer sm:footer-horizontal bg-gradient-to-l to-[#FFF2F2] from-[#A9B5DF] text-base-content p-10 mx-4 overflow-x-hidden">
