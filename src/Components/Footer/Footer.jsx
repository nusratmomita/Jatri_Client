...
const Footer = () => {
    return (
       <footer className="mt-80 flex lg:flex-row flex-col justify-between rounded-[40px] footer sm:footer-horizontal bg-gradient-to-l to-[#FFF2F2] from-[#A9B5DF] text-base-content p-10">
